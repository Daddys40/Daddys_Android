...
//		UserData.init(ResultActivity.this);
//		EnrollAlarm.getInstance().setAlarm(ResultActivity.this);
//		Intent intent = getIntent();
//		initView();
//		initEvent();
//		QnADataContainer.getInstance().doDeserialization(ResultActivity.this);
...
//				DialogMaker dm = new DialogMaker(ResultActivity.this, R.layout.dialog_event, 1, 1);
...
//
//		mBtnShare = (Button) findViewById(R.id.btn_result_share);
//		mBtnSetting = (Button) findViewById(R.id.btn_result_setting);
//		mBtnShowDlg = (Button) findViewById(R.id.btn_result_show);
//
//		mIvIcon = (ImageView) findViewById(R.id.iv_result_icon);
//		mIvIcon.setImageResource(ICON_ID[UserData.getInstance().currentWeek() / 2]);
//		((RelativeLayout) findViewById(R.id.lay_result_background)).setBackgroundColor(BACK_COLOR[UserData
...
//			((ImageView) findViewById(R.id.iv_result_bottom)).setBackgroundResource(R.drawable.illust_allsame_black);
...
//		}
//		else{
//			((ImageView) findViewById(R.id.iv_result_bottom)).setBackgroundResource(R.drawable.illust_allsame_white);
...
//				DialogMaker dm = new DialogMaker(ResultActivity.this, R.layout.dialog_share);
...
//					public void onClick(View v) {
//						try {
//							final KakaoLink kakaoLink = KakaoLink.getKakaoLink(ResultActivity.this);
...
//							kakaoLink.sendMessage(linkContents, ResultActivity.this);
//						}
//						catch (Exception e) {
//							e.printStackTrace();
//						}
...
//			@Override
//			public void onClick(View arg0) {
//				startActivityForResult(new Intent(ResultActivity.this, SettingActivity.class), 0);
//			}
//		});
//	}
//
...
//		DialogMaker dm = new DialogMaker(this, R.layout.dialog_result, 1.0, 1.0);
...
//		int setWeek = UserData.getInstance().currentWeek();
//		//주차 옮기는 기능 보류
////		if(mCurrentState == PREV_WEEK){
////			((Button) mResultDialog.findViewById(R.id.btn_result_prev)).setVisibility(View.GONE);
////			((Button) mResultDialog.findViewById(R.id.btn_result_next)).setVisibility(View.VISIBLE);
////			setWeek--;
////		}
////		else if(mCurrentState == NEXT_WEEK){
////			((Button) mResultDialog.findViewById(R.id.btn_result_next)).setVisibility(View.GONE);
